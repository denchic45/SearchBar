...
import static com.github.searchbar.Utils.DimensionUtils.dpToPx;
...
public class SearchBar extends LinearLayout {
    ...
    private void setExpand(boolean inputEnable) {
        switch (expandable) {
    ...
    private void noAnimateExpanding(boolean expand) {
        ...
        if (expand) {
            ...
            layoutParams.leftMargin = dpToPx(0, getContext());
            layoutParams.rightMargin = dpToPx(0, getContext());
            layoutParams.topMargin = dpToPx(0, getContext());
            layoutParams.bottomMargin = dpToPx(2, getContext());
        } else {
            cardView.setRadius(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 6, getContext().getResources().getDisplayMetrics()));
            layoutParams.leftMargin = dpToPx(16, getContext());
            layoutParams.rightMargin = dpToPx(16, getContext());
            layoutParams.topMargin = dpToPx(6, getContext());
            layoutParams.bottomMargin = dpToPx(6, getContext());
        }
